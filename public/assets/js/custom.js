...
$(function() {
    ...
    $('.right-sidenav').sidenav({
        edge: 'right',
        onOpenStart: function() {
            $('.messenger-windows').addClass('show-chat');
            $('.messenger-windows').removeClass('hide-chat');
        },
        onCloseStart: function() {
            $('.messenger-windows').addClass('hide-chat');
            $('.messenger-windows').removeClass('show-chat');
        }
    });
    // ==============================================================
    // Perfect Scrollbar
