...
@section('content')
            ...
            <div class="col-12 col-lg-4">
                <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto" style="position: absolute;left: 80%;">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="ml-3" href="{{ Route('post.detail',['id' => $post->id]) }}"
                                        ...
                                        @endif
                                        <a class="ml-3" href="{{ Route('post.edit',['id' => $post->id]) }}"
                                           style="text-decoration: none; color: black">Chỉnh sửa bài viết</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="app-card-body px-4">
                        <div class="intro">
                            <p class="text-column" style="font-size: 14px;display: -webkit-box;max-height: 3.2rem;-webkit-box-orient: vertical;overflow: hidden;
                    ...
                    <span tabindex="0" data-toggle="tooltip" title="Xóa bài viết">
                                    <button class="btn btn-danger" id="btn-delete" value="{{ $post->id }}"
                                            style="position: absolute;left: 81%;bottom: 25px;">
                                        <span>
                                            <i class="far fa-trash-alt" style="color: #dcdfe5;"></i></span></button>
                                </span>
                </div>
            </div>
        @endforeach
    ...
    <style>
        ...
        * {
        ...
        .toggle.focus .slider, .checkbox.focus .check {
